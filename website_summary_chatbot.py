...
if load_button:
    if not url_input:
        ...
        if full_text:
            ...
            st.info(
                "Website content could not be fully read. "
                "You can still ask me about this website."
            )
        st.rerun()
    ...
    **[{st.session_state.website_url}]({st.session_state.website_url})**
    ...
    if st.session_state.website_context_ready and not history.messages:
        history.add_ai_message(
            "I’m ready 👍 Ask me anything about this website — what it is, what it does, or how it’s used."
        )
...
Website Content:
{st.session_state.website_text[:15000]}
"""),
